function [filename]=calc_pco2(grd,tavesteps)
...
if exist('~/Dropbox/Applications/ferret/woa01_siz.nc','file')
    sifname='~/Dropbox/Applications/ferret/woa01_siz.nc';
...
nc_addvar(filename,struct('Name','new_ff_calc','Datatype','float','Dimension',{{'T','Z','Y','X'}}));
nc_addvar(filename,struct('Name','new_ffp_calc','Datatype','float','Dimension',{{'T','Z','Y','X'}}));
nc_addvar(filename,struct('Name','new_k0_calc','Datatype','float','Dimension',{{'T','Z','Y','X'}}));
nc_addvar(filename,struct('Name','new_k1_calc','Datatype','float','Dimension',{{'T','Z','Y','X'}}));
nc_addvar(filename,struct('Name','new_k2_calc','Datatype','float','Dimension',{{'T','Z','Y','X'}}));
...
nc_attput(filename,'new_ff_calc','units','mol/kg/atm');
nc_attput(filename,'new_ffp_calc','units','mol/kg/atm');
nc_attput(filename,'new_k0_calc','units','mol/kg/atm');
nc_attput(filename,'new_k1_calc','units','mol/kg');
nc_attput(filename,'new_k2_calc','units','mol/kg');
...
nc_attput(filename,'new_ff_calc','title','Full depth corrected solubility of CO2 in seawater');
nc_attput(filename,'new_ffp_calc','title','Full depth corrected solubility of CO2 in seawater with pressure term');
nc_attput(filename,'new_k0_calc','title','Full depth solubility of CO2 in seawater');
nc_attput(filename,'new_k1_calc','title','Full depth carbonic acid dissociation constant');
nc_attput(filename,'new_k2_calc','title','Full depth bicarbonate dissociation constant');
...
% ff=nan(grd.nx,grd.ny,grd.nz);
% ffp=nan(grd.nx,grd.ny,grd.nz);
% k0=nan(grd.nx,grd.ny,grd.nz);
% k1=nan(grd.nx,grd.ny,grd.nz);
% k2=nan(grd.nx,grd.ny,grd.nz);
% hnew=nan(grd.nx,grd.ny,grd.nz);
% phnew=nan(grd.nx,grd.ny,grd.nz);
% co2s=nan(grd.nx,grd.ny,grd.nz);
% pco2=nan(grd.nx,grd.ny,grd.nz);
% co3=nan(grd.nx,grd.ny,grd.nz);
...
%     co3_temp(isnan(co3_temp))=(-1e34);
    ...
    ph_data.new_ff_calc = permute(change(ff,'==',NaN,-1e34),[3,2,1]);
    ph_data.new_ffp_calc = permute(change(ffp,'==',NaN,-1e34),[3,2,1]);
    ph_data.new_k0_calc = permute(change(k0,'==',NaN,-1e34),[3,2,1]);
    ph_data.new_k1_calc = permute(change(k1,'==',NaN,-1e34),[3,2,1]);
    ph_data.new_k2_calc = permute(change(k2,'==',NaN,-1e34),[3,2,1]);
